...
<div id="ModalDokumen<?php echo $pen['ID_PENGHARGAAN']; ?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      ...
      <div class="modal-body">
      <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url('Action/doDokumenPenghargaan/'.$pen['ID_PENGHARGAAN']); ?>" method="post">
        <div class="form-group">
          <label class="control-label col-sm-3">Sertifikat:</label>
          <div class="col-sm-5">
            <input type="file" name="SERTIFIKAT" class="inputFile" accept="application/pdf">
...
<!--modal delete-->
<div id="ModalDelete<?php echo $pen['ID_PENGHARGAAN']; ?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Hapus Data Penghargaan</h4>
      </div>
      <div class="modal-body">
      <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url('Action/doDeletePenghargaan/'.$pen['ID_PENGHARGAAN']); ?>" method="post">
        <h4 style="text-align:center">Anda yakin ingin menghapus data Penghargaan?</h4>
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary">Submit</button>
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>

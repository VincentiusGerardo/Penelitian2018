...
<?php foreach($pembimbing as $pem){ ?>
<!-- Modal Edit -->
<div id="ModalEdit<?php echo $pem['ID_PEMBIMBING']; ?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      ...
      <div class="modal-body">
        <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url('Action/doUpdatePembimbing/'.$pem['ID_PEMBIMBING']); ?>" method="post">
         <div class="form-group">
           <label class="control-label col-sm-3">Nama:</label>
           <div class="col-sm-9">
...
<div id="ModalDokumen<?php echo $pem['ID_PEMBIMBING']; ?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      ...
      <div class="modal-body">
      <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url('Action/doDokumenPembimbing/'.$pem['ID_PEMBIMBING']); ?>" method="post">
        <div class="form-group">
          <label class="control-label col-sm-3">SK:</label>
          <div class="col-sm-5">
            <input type="file" name="SK" class="inputFile" accept="application/pdf">
...
<!--modal delete-->
<div id="ModalDelete<?php echo $pem['ID_PEMBIMBING']; ?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Hapus Data Pembimbing</h4>
      </div>
      <div class="modal-body">
      <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url('Action/doDeletePembimbing/'.$pem['ID_PEMBIMBING']); ?>" method="post">
        <h4 style="text-align:center">Anda yakin ingin menghapus data pembimbing?</h4>
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary">Submit</button>
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
